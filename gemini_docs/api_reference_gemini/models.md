...
### Python
    ...
    print(model_info)  
    https://github.com/google-gemini/api-examples/blob/9f5adb78a77820ef2d4f2a040d698481803e8214/python/models.py#L41-L45
...
### Go
    ...
    https://github.com/google-gemini/api-examples/blob/9f5adb78a77820ef2d4f2a040d698481803e8214/go/models.go#L55-L69
    ...
    for m in client.models.list():
        for action in m.supported_actions:
            if action == "embedContent":
                print(m.name)  
    https://github.com/google-gemini/api-examples/blob/9f5adb78a77820ef2d4f2a040d698481803e8214/python/models.py#L22-L36
...
### Go
    ...
    https://github.com/google-gemini/api-examples/blob/9f5adb78a77820ef2d4f2a040d698481803e8214/go/models.go#L14-L48
